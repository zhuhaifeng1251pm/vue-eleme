                    ...
                    <div class="information">
                        ...
                        <div class="price">
                            ...
                            <div class="change-num">
                                <img src="../assets/-.svg" alt="" :style="`display:${$store.getters.showGoodsNum(food,food.id)?'flex':'none'}`" @click="$store.commit('subCarts',food.id)">
                                <span :style="`display:${$store.getters.showGoodsNum(food,food.id)?'flex':'none'}`">{{$store.getters.showGoodsNum(food,food.id)}}</span>
